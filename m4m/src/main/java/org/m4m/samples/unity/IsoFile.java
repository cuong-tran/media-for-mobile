...
public class IsoFile extends BasicContainer implements Closeable {
     ...
     */
    public IsoFile(Context c, String filename) throws IOException {
        this(c, new FileDataSourceImpl(new File(filename)));
    }
     ...
     * @throws IOException in case I/O error
     */
    public IsoFile(Context c, DataSource dataSource) throws IOException {
        parseContainer(dataSource, dataSource.size(), new PropertyBoxParserImpl(c));
