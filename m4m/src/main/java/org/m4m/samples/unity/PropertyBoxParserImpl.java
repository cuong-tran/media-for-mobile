...
public class PropertyBoxParserImpl extends AbstractBoxParser {
    ...
    public PropertyBoxParserImpl(Context c, String... customProperties) {
        //InputStream is = getClass().getResourceAsStream("/isoparser-default.properties");
        InputStream is = null;
        try {
            is = c.getContentResolver().openInputStream(Uri.fromFile(Utils.getAppDataFile(c, "isoparser-default.properties")));
        } catch (IOException e) {
            e.printStackTrace();
        }
        try {
