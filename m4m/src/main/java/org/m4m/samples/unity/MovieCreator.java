...
public class MovieCreator {
    ...
    public static Movie build(Context c, String file) throws IOException {
        return build(c, new FileDataSourceImpl(new File(file)));
    }
     ...
     */
    public static Movie build(Context c, DataSource channel) throws IOException {
        IsoFile isoFile = new IsoFile(c, channel);
        Movie m = new Movie();
